      ...
      <div className="flex-1 flex items-center justify-center py-20 px-6 relative z-10">
        ...
        <div className="w-full max-w-[420px] glass-card p-10 rounded-[4px] border border-white/[0.08] shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[13px] text-zinc-400 font-sans mt-2">Sign in to continue your study flow.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="block text-xs font-mono text-zinc-400 uppercase tracking-widest font-semibold">Password</label>
                <Link to="/forgot-password" className="text-[11px] font-mono text-indigo-400 hover:text-indigo-300">
                  Forgot?
                </Link>
              </div>
              <div className="relative">
