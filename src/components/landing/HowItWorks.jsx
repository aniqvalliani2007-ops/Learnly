...
export const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className="py-32 bg-zinc-950 border-y border-white/5 relative">
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-24">
          ...
          <motion.p 
            ...
            className="mt-6 text-lg text-neutral-400 font-sans max-w-2xl mx-auto"
          >
          ...
          {steps.map((item, index) => {
            ...
            return (
              <motion.div 
                ...
                className="bg-black border border-white/5 p-8 rounded-2xl relative overflow-hidden group hover:border-primary/50 transition-colors"
              >
                ...
                <div className="w-14 h-14 rounded-full bg-zinc-900 border border-white/10 flex items-center justify-center mb-8 relative z-10">
                ...
                <h3 className="text-2xl font-bold text-white tracking-tight mb-4 relative z-10">{item.title}</h3>
                <p className="text-neutral-400 text-base leading-relaxed relative z-10">{item.description}</p>
              </motion.div>
            )
          })}
        </div>
